...
public class ProduitDao {
	...
	public Collection<Produit> findByLibelle(String libelle){
		  TypedQuery<Produit>  query= em.createQuery("SELECT p FROM Produit p WHERE p.libelle LIKE :libelle ORDER BY libelle ASC", Produit.class);
	...
	public Collection<Produit> findByMarque(String marque){
		  TypedQuery<Produit>  query= em.createQuery("SELECT p FROM Produit p JOIN  p.marque m WHERE m.libelle=:marque ORDER BY p.libelle ASC", Produit.class);
